...
    autoFitPadding: 56,
    cooldownTime: 4200,
    d3VelocityDecay: 0.04, // 0.08 → 0.04로 변경하여 관성 강화
    d3AlphaMin: 0.0001,
...
    linkStrength: 1.5,     // 1.3 → 1.5로 변경하여 인력 강화
...
      book: 0.70,      // 책
      attribute: 0.70, // 0.72 → 0.70으로 변경
      other: 0.72,     // 0.74 → 0.72로 변경
    }),
...
      // setTimeout(() => { graphRef.current?.d3AlphaTarget?.(0); }, 400); // ⚠️ 이 줄을 제거하여 자연스러운 감쇠를 유도
    } catch {}
